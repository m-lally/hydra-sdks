/**
 * Hydra Payment Service - React Hooks
 * 
 * Custom hooks for React applications integrating with Hydra Payment Service
 */

import { useState, useCallback, useEffect, useRef, createContext, useContext } from 'react';
import { HydraClient, createHydraClient } from '../client';
import type { SDKOptions, Account, Transaction, Wallet, SplitRule, ApiResponse } from '../types';
...
function useHydraClient(): HydraClient {
